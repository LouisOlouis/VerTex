...
| Arquivo | Conteúdo |
|---|---|
| [`REGRAS.md`](CORE/REGRAS.md) | Núcleo do sistema: dados, dificuldade, margem, atributos, perícias, estatísticas derivadas, Sorte, Determinação, Condições, Progressão, Equipamentos (regras), Exploração, Conflitos Sociais |
| [`CRIACAO_PERSONAGEM.md`](Player/CRIACAO_PERSONAGEM.md) | Passo a passo de criação de personagem, com 3 personagens de exemplo prontos |
| [`FICHA.md`](Player/FICHA.md) | Ficha de personagem em branco, em texto |
